...
class qtype_randomconstrained_edit_form extends question_edit_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('questioncategory', 'category', get_string('category', 'qtype_randomconstrained'),
                array('contexts' => $this->contexts->having_cap('moodle/question:useall')));

        $mform->addElement('advcheckbox', 'questiontext[text]',
                get_string('includingsubcategories', 'qtype_randomconstrained'), null, null, array(0, 1));
