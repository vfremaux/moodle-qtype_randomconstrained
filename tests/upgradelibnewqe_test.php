 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_randomconstrained_attempt_upgrader_test extends question_attempt_upgrader_test_base {

    public function test_randomconstrained_deferredfeedback_history620() {
        $quiz = (object) array(
            'id' => '2177',
            'course' => '5174',
            'name' => 'iCMA 41',
        ...
        $question = (object) array(
            ...
            'category' => '3762',
            'parent' => '34248',
            'name' => 'Random Constrained Question (Q2)',
            'questiontext' => '1',
        ...
        $qstates = array(
            3820084 => (object) array(
                ...
                'originalquestion' => '0',
                'seq_number' => '0',
                'answer' => 'randomconstrained34999-103135,103136,103137:',
            ...
            4009916 => (object) array(
                ...
                'originalquestion' => '0',
                'seq_number' => '1',
                'answer' => 'randomconstrained34999-103135,103136,103137:103137',
...
<p>Which was the first year when more than a quarter of a million households received care from independent agencies?</p>',
    ...
    public function test_randomconstrained_deferredfeedback_qsession4225582() {
        $quiz = (object) array(
            'id' => '4410',
            'course' => '5444',
...
101995,101987,0,101983,101993,101996,0',
        ...
        $question = (object) array(
            ...
            'category' => '9148',
            'parent' => '101984',
            'name' => 'Random Constrained Question (Block 3, Session 5 Quiz)',
            'questiontext' => '1',
            'questiontextformat' => '0',
            'image' => '',
            'defaultmark' => '1',
        ...
        $qstates = array(
            10786382 => (object) array(
                ...
                'originalquestion' => '0',
                'seq_number' => '0',
                'answer' => 'randomconstrained98355-341067,341066,341068:',
            ...
            10786398 => (object) array(
                ...
                'originalquestion' => '0',
                'seq_number' => '1',
                'answer' => 'randomconstrained98355-341067,341066,341068:341061',
                'timestamp' => '1274178725',
                'event' => '2',
                'grade' => '0',
                'raw_grade' => '0',
            ...
            10786515 => (object) array(
                ...
                'originalquestion' => '0',
                'seq_number' => '2',
                'answer' => 'randomconstrained98355-341067,341066,341068:341067',
...
82800,0,82801,0,82802,0,82803,0,82804,0,82805,0,82806,0,82807,0',
        ...
        $qstates = array(
            ...
            9107452 => (object) array(
                ...
                'originalquestion' => '0',
                'seq_number' => '1',
                'answer' => 'randomconstrained83248-64',
