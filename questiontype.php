...
class qtype_randomconstrained extends question_type {
    ...
    public function question_name($category, $includesubcategories) {
        if ($includesubcategories) {
            $string = 'randomconstrainedqplusname';
        } else {
            $string = 'randomconstrainedqname';
        }
        return get_string($string, 'qtype_randomconstrained', shorten_text($category->name, 100));
    }
    ...
    protected function set_selected_question_name($question, $randomname) {
        ...
        $question->name = get_string('selectedby', 'qtype_randomconstrained', $a);
    }
