...
$string['pluginname'] = 'Random with constraints';
$string['pluginname_help'] = 'A random constrained question is not a question type as such, but is a way of inserting a randomly-chosen question from a specified set of categories into an activity.';
$string['pluginnameediting'] = 'Editing a random constrained question';
